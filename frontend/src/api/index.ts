...
import type { ApiResponse, PageResult, UserInfo, Customer, Contract, DeliveryOrder, Invoice, Payment, Reconciliation, ReconciliationUnit, Product, ProductCategory, Order } from '@/types'
...
export const orderApi = {
  ...
  create: (data: Partial<Order>) =>
    request.post<any, ApiResponse<Order>>('/orders', data),
  update: (id: number, data: Partial<Order>) =>
    request.put<any, ApiResponse<Order>>(`/orders/${id}`, data),
  delete: (id: number) =>
    request.delete<any, ApiResponse>(`/orders/${id}`),
  createDelivery: (orderId: number, data: any) =>
    request.post<any, ApiResponse<DeliveryOrder>>(`/orders/${orderId}/delivery`, data)
}
...
export const productCategoryApi = {
  list: () =>
    request.get<any, ApiResponse<ProductCategory[]>>('/product-categories'),
  get: (id: number) =>
    request.get<any, ApiResponse<ProductCategory>>(`/product-categories/${id}`),
  getByCode: (code: string) =>
    request.get<any, ApiResponse<ProductCategory>>(`/product-categories/code/${code}`),
  create: (data: any) =>
    request.post<any, ApiResponse<ProductCategory>>('/product-categories', data),
  update: (id: number, data: any) =>
    request.put<any, ApiResponse<ProductCategory>>(`/product-categories/${id}`, data),
  delete: (id: number) =>
    request.delete<any, ApiResponse>(`/product-categories/${id}`),
  initDefaults: () =>
    request.post<any, ApiResponse<{ message: string }>>('/product-categories/init')
}
